...
public val MyIconPack.`Eye-off-svgrepo-com`: ImageVector
    get() {
        if (`_eye-off-svgrepo-com` != null) {
            return `_eye-off-svgrepo-com`!!
        }
        `_eye-off-svgrepo-com` = Builder(name = "Eye-off-svgrepo-com", defaultWidth = 800.0.dp,
...
private var `_eye-off-svgrepo-com`: ImageVector? = null
